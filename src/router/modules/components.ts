...
export default [
  ...
  //   component: Layout,
  //   redirect: '/list/base',
  //   meta: { title: '列表页', icon: ListIcon, orderNo: 100 },
  //   children: [
  //     {
  //       path: 'base',
  //       name: 'ListBase',
  //       component: () => import('@/pages/list/base/index.vue'),
  //       meta: { title: '基础列表页', orderNo: 1 },
  //     },
  //     {
  //       path: 'card',
  //       name: 'ListCard',
  //       component: () => import('@/pages/list/card/index.vue'),
  //       meta: { title: '卡片列表页', orderNo: 0 },
  //     },
  //     {
  //       path: 'filter',
  //       name: 'ListFilter',
  ...
  //   component: Layout,
  //   redirect: '/form/base',
  //   meta: { title: '表单页', icon: FormIcon, orderNo: 100 },
  //   children: [
  //     {
  //       path: 'base',
  //       name: 'FormBase',
  ...
  //   meta: { title: '详情页', icon: DetailIcon, orderNo: 100 },
  //   children: [
  //     {
  //       path: 'base',
  //       name: 'DetailBase',
  ...
  // },
  {
    ...
    meta: { title: '结果页', icon: 'check-circle', orderNo: 100, hidden: true },
    children: [
      {
        path: 'success',
        name: 'ResultSuccess',
