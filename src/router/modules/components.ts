...
export default [
  {
    ...
    component: Layout,
    redirect: '/list/base',
    meta: { title: '列表页', icon: ListIcon, orderNo: 1 },
    children: [
      {
        path: 'base',
        name: 'ListBase',
  ...
  },
  {
    ...
    component: Layout,
    redirect: '/form/base',
    meta: { title: '表单页', icon: FormIcon, orderNo: 1 },
    children: [
      {
        path: 'base',
        name: 'FormBase',
  ...
  },
  {
    ...
    meta: { title: '详情页', icon: DetailIcon, orderNo: 1 },
    children: [
      {
        path: 'base',
        name: 'DetailBase',
  ...
  },
  {
    ...
    meta: { title: '结果页', icon: 'check-circle', orderNo: 1 },
    children: [
      {
        path: 'success',
        name: 'ResultSuccess',
